  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center space-y-6">
        <ActivityBarButton>
          <a className="linkAttribution" href="https://github.com/jorge-menjivar/unSAGED" target="_blank">
            <IconBrandGithub size={28} />
          </a>
        </ActivityBarButton>
        <ActivityBarButton>
          <a className="linkAttribution" href="https://discord.gg/rMH2acSEzq" target="_blank">
